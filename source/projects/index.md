...
以下是我開發的產品與專案，涵蓋 AI 應用、全端開發與自動化系統。如果你有類似需求，歡迎[聯繫我](/about/)討論合作。

---

## Glean — AI 碎片筆記系統

**一句話介紹：** 自動收集、整理散落在各通訊平台的筆記與會議記錄，用 AI 分類並追蹤待辦事項。
...
**技術棧：** Next.js 14, Hono, PostgreSQL + pgvector, vLLM (Qwen3), Whisper, Discord.js, Tailwind CSS

---

## Radar — 求職準備平台

**一句話介紹：** 社群驅動的求職工具，整合面試經驗分享、申請追蹤與履歷產生功能。
...
**技術棧：** SvelteKit, FastAPI, SQLAlchemy, PostgreSQL, Tailwind CSS + DaisyUI, Docker

---

## AutoBill — 智慧帳單處理

**一句話介紹：** 基於 LLM 的自動帳單辨識與處理微服務，為 myPDA 生態系打造。
...
**技術棧：** FastAPI, OpenAI-compatible API (vLLM/Ollama), pgvector, asyncpg, structlog

---

## 想了解更多？

以上專案皆為實際運行的產品。如果你有類似需求，或想將 AI 技術整合進你的業務流程，歡迎[聯繫我](/about/)，我們可以聊聊怎麼幫你解決問題。
